...
export const RESPONSIVE_FORM_MODAL_BODY_CLASS =
  'flex-1 overflow-y-auto overscroll-contain px-4 pt-4 pb-8 sm:px-5 sm:pt-5 sm:pb-10 md:px-6 md:pt-5 md:pb-12 tablet-portrait:pb-14 landscape:px-4 landscape:pt-4 landscape:pb-8 landscape-short:px-3 landscape-short:pt-3 landscape-short:pb-6 min-h-0';

export const RESPONSIVE_FORM_MODAL_FOOTER_CLASS =
  'shrink-0 border-t border-slate-100 bg-white px-4 pt-4 pb-[max(1.25rem,env(safe-area-inset-bottom,0px))] sm:px-5 sm:pt-4 sm:pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] md:px-6 md:pt-5 md:pb-[max(1.75rem,env(safe-area-inset-bottom,0px))] tablet-portrait:pt-5 tablet-portrait:pb-[max(2.5rem,env(safe-area-inset-bottom,0px))] landscape:px-4 landscape:pt-3 landscape-short:px-3 landscape-short:pt-2.5 flex flex-col sm:flex-row gap-2 sm:gap-3';

export const RESPONSIVE_FORM_MODAL_NAV_CLASS =
  'px-4 py-3 sm:px-5 sm:py-4 md:px-6 md:py-3 tablet-portrait:py-3 landscape:px-4 landscape:py-2.5 landscape-short:py-2 bg-white border-b border-slate-100 shrink-0';
