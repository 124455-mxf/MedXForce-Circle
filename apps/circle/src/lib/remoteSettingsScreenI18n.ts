...
const TOGGLE_LABEL_KEYS: Record<string, string> = {
  ...
  minimizeTextWindowHeight: 'remoteSettings.toggles.minimizeTextWindowHeight',
  enableAudioInput: 'remoteSettings.toggles.enableAudioInput',
  showTranslateButton: 'remoteSettings.toggles.showTranslateButton',
...
const TOGGLE_DESC_KEYS: Record<string, string> = {
  ...
  minimizeTextWindowHeight: 'remoteSettings.toggleDesc.minimizeTextWindowHeight',
  enableAudioInput: 'remoteSettings.toggleDesc.enableAudioInput',
  showTranslateButton: 'remoteSettings.toggleDesc.showTranslateButton',
