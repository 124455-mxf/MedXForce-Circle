...
const TOGGLE_LABEL_KEYS: Record<string, string> = {
  ...
  'featuresVisibility.intensiveCareSoulMusic': 'remoteSettings.toggles.icuSoulMusic',
  'featuresVisibility.intensiveCareSoulMediaLibrary': 'remoteSettings.toggles.icuSoulMedia',
  'featuresVisibility.intensiveCarePainAssessment': 'remoteSettings.toggles.icuPain',
  'featuresVisibility.intensiveCareDoctorQuickAnswers': 'remoteSettings.toggles.icuDoctor',
...
const TOGGLE_DESC_KEYS: Record<string, string> = {
  ...
  'featuresVisibility.intensiveCareSoulMusic': 'remoteSettings.toggleDesc.icuSoulMusic',
  'featuresVisibility.intensiveCareSoulMediaLibrary': 'remoteSettings.toggleDesc.icuSoulMedia',
  'featuresVisibility.intensiveCarePainAssessment': 'remoteSettings.toggleDesc.icuPain',
  'featuresVisibility.intensiveCareDoctorQuickAnswers': 'remoteSettings.toggleDesc.icuDoctor',
