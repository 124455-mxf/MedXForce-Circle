...
const profileEnglish = {
  ...
  accountHideAria: 'Hide patient app account details',
  accountShowAria: 'Show patient app account details',
  ...
  sectionExtendedShort: 'Extended',
  sectionEngagement: 'Engagement',
  sectionEngagementShort: 'Engage',
  sectionLifestyle: 'Lifestyle',
  sectionLifestyleShort: 'Lifestyle',
  sectionFunctional: 'Functional',
  sectionFunctionalShort: 'Function',
  sectionClinical: 'Clinical',
  sectionClinicalShort: 'Clinical',
  sectionReferences: 'Clinical references',
  sectionReferencesShort: 'References',
  fieldName: 'Name',
  ...
  alcoholNone: 'No alcohol',
  alcoholOccasionally: 'Occasionally',
  alcoholOnceAWeek: 'Once a week',
  alcoholEveryDay: 'Every day',
  assistiveCane: 'Cane',
  assistiveWalker: 'Walker',
  assistiveWheelchair: 'Wheelchair',
  assistiveOrthotics: 'Orthotics',
  assistiveProsthetics: 'Prosthetics',
  ...
  fieldCigarettesPerDay: 'Cigarettes per day',
  fieldVaping: 'Vaping',
  fieldAlcoholFrequency: 'Alcohol frequency',
  fieldRecreationalDrugs: 'Recreational drugs',
  sexMale: 'Male',
  sexFemale: 'Female',
  sexOther: 'Other',
  handednessLeft: 'Left',
  handednessRight: 'Right',
  handednessAmbidextrous: 'Ambidextrous',
  raceWhite: 'White',
  raceHispanic: 'Hispanic',
  raceBlack: 'Black',
  raceMena: 'Middle Eastern / North African',
  raceAsian: 'Asian',
  raceNativeAmerican: 'Native American',
  raceNativeHawaiian: 'Native Hawaiian',
  thePatient: 'the patient',
  previousSectionAria: 'Previous section',
  nextSectionAria: 'Next section',
  listSeparateHint: 'Separate items with commas',
  medAdd: 'Add',
  medEmpty: 'No entries yet.',
  medEntry: 'Entry {{n}}',
  medRemoveAria: 'Remove {{label}} entry',
  medName: 'Name',
  medDosage: 'Dosage',
...
const contactEnglish = {
  ...
  placeholderFirstName: 'Optional',
  placeholderLastName: 'Optional',
...
const profileGerman = {
  ...
  accountHideAria: 'Patienten-App-Kontodetails ausblenden',
  accountShowAria: 'Patienten-App-Kontodetails anzeigen',
  ...
  sectionIdentityShort: 'Identität',
  sectionExtended: 'Erweitert',
  sectionExtendedShort: 'Erweitert',
  sectionEngagement: 'Engagement',
  sectionEngagementShort: 'Engage',
  sectionLifestyle: 'Lebensstil',
  sectionLifestyleShort: 'Leben',
  sectionFunctional: 'Funktional',
  sectionFunctionalShort: 'Funktion',
  sectionClinical: 'Klinisch',
  sectionClinicalShort: 'Klinisch',
  sectionReferences: 'Klinische Referenzen',
  sectionReferencesShort: 'Referenzen',
  fieldName: 'Name',
  ...
  alcoholNone: 'Kein Alkohol',
  alcoholOccasionally: 'Gelegentlich',
  alcoholOnceAWeek: 'Einmal pro Woche',
  alcoholEveryDay: 'Jeden Tag',
  assistiveCane: 'Gehstock',
  assistiveWalker: 'Rollator',
  assistiveWheelchair: 'Rollstuhl',
  assistiveOrthotics: 'Orthesen',
  assistiveProsthetics: 'Prothesen',
  ...
  fieldCigarettesPerDay: 'Zigaretten pro Tag',
  fieldVaping: 'Dampfen',
  fieldAlcoholFrequency: 'Alkoholkonsum',
  fieldRecreationalDrugs: 'Freizeitdrogen',
  sexMale: 'Männlich',
  sexFemale: 'Weiblich',
  sexOther: 'Divers',
  handednessLeft: 'Links',
  handednessRight: 'Rechts',
  handednessAmbidextrous: 'Beidhändig',
  raceWhite: 'Weiß',
  raceHispanic: 'Hispanisch',
  raceBlack: 'Schwarz',
  raceMena: 'Naher Osten / Nordafrika',
  raceAsian: 'Asiatisch',
  raceNativeAmerican: 'Native American',
  raceNativeHawaiian: 'Native Hawaiian',
  thePatient: 'der Patient',
  previousSectionAria: 'Vorheriger Abschnitt',
  nextSectionAria: 'Nächster Abschnitt',
  listSeparateHint: 'Einträge durch Kommas trennen',
  medAdd: 'Hinzufügen',
  medEmpty: 'Noch keine Einträge.',
  medEntry: 'Eintrag {{n}}',
  medRemoveAria: '{{label}}-Eintrag entfernen',
  medName: 'Name',
  medDosage: 'Dosierung',
  medSchedule: 'Zeitplan',
...
const profileSpanish = {
  ...
  accountHideAria: 'Ocultar detalles de la cuenta de la app del paciente',
  accountShowAria: 'Mostrar detalles de la cuenta de la app del paciente',
  ...
  sectionIdentityShort: 'Identidad',
  sectionExtended: 'Extendido',
  sectionExtendedShort: 'Extendido',
  sectionEngagement: 'Compromiso',
  sectionEngagementShort: 'Compromiso',
  sectionLifestyle: 'Estilo de vida',
  sectionLifestyleShort: 'Estilo',
  sectionFunctional: 'Funcional',
  sectionFunctionalShort: 'Función',
  sectionClinical: 'Clínico',
  sectionClinicalShort: 'Clínico',
  sectionReferences: 'Referencias clínicas',
  sectionReferencesShort: 'Referencias',
  fieldName: 'Nombre',
  fieldNickname: 'Apodo',
  fieldEmail: 'Correo',
  ...
  alcoholNone: 'Sin alcohol',
  alcoholOccasionally: 'Ocasionalmente',
  alcoholOnceAWeek: 'Una vez a la semana',
  alcoholEveryDay: 'Todos los días',
  assistiveCane: 'Bastón',
  assistiveWalker: 'Andador',
  assistiveWheelchair: 'Silla de ruedas',
  assistiveOrthotics: 'Órtesis',
  assistiveProsthetics: 'Prótesis',
  ...
  fieldSmoking: 'Tabaco',
  fieldCigarettesPerDay: 'Cigarrillos al día',
  fieldVaping: 'Vapeo',
  fieldAlcoholFrequency: 'Frecuencia de alcohol',
  fieldRecreationalDrugs: 'Drogas recreativas',
  sexMale: 'Hombre',
  sexFemale: 'Mujer',
  sexOther: 'Otro',
  handednessLeft: 'Izquierda',
  handednessRight: 'Derecha',
  handednessAmbidextrous: 'Ambidiestro',
  raceWhite: 'Blanco',
  raceHispanic: 'Hispano',
  raceBlack: 'Negro',
  raceMena: 'Oriente Medio / Norte de África',
  raceAsian: 'Asiático',
  raceNativeAmerican: 'Nativo americano',
  raceNativeHawaiian: 'Nativo hawaiano',
  thePatient: 'el paciente',
  previousSectionAria: 'Sección anterior',
  nextSectionAria: 'Sección siguiente',
  listSeparateHint: 'Separe los elementos con comas',
  medAdd: 'Añadir',
  medEmpty: 'Aún no hay entradas.',
  medEntry: 'Entrada {{n}}',
  medRemoveAria: 'Quitar entrada de {{label}}',
  medName: 'Nombre',
  medDosage: 'Dosis',
  medSchedule: 'Pauta',
...
const contactSpanish = {
  ...
  placeholderFirstName: 'Opcional',
  placeholderLastName: 'Opcional',
...
const profilePolish = {
  ...
  accountHideAria: 'Ukryj szczegóły konta aplikacji pacjenta',
  accountShowAria: 'Pokaż szczegóły konta aplikacji pacjenta',
  ...
  sectionIdentityShort: 'Tożsamość',
  sectionExtended: 'Rozszerzone',
  sectionExtendedShort: 'Rozszerz.',
  sectionEngagement: 'Zaangażowanie',
  sectionEngagementShort: 'Zaangaż.',
  sectionLifestyle: 'Styl życia',
  sectionLifestyleShort: 'Styl',
  sectionFunctional: 'Funkcjonalne',
  sectionFunctionalShort: 'Funkcja',
  sectionClinical: 'Kliniczne',
  sectionClinicalShort: 'Kliniczne',
  sectionReferences: 'Materiały kliniczne',
  sectionReferencesShort: 'Materiały',
  ...
  alcoholNone: 'Bez alkoholu',
  alcoholOccasionally: 'Okazjonalnie',
  alcoholOnceAWeek: 'Raz w tygodniu',
  alcoholEveryDay: 'Codziennie',
  assistiveCane: 'Laska',
  assistiveWalker: 'Chodzik',
  assistiveWheelchair: 'Wózek inwalidzki',
  assistiveOrthotics: 'Ortezy',
  assistiveProsthetics: 'Protezy',
  ...
  fieldCigarettesPerDay: 'Papierosy dziennie',
  fieldVaping: 'Vaping',
  fieldAlcoholFrequency: 'Częstość picia alkoholu',
  fieldRecreationalDrugs: 'Narkotyki rekreacyjne',
  sexMale: 'Mężczyzna',
  sexFemale: 'Kobieta',
  sexOther: 'Inna',
  handednessLeft: 'Lewa',
  handednessRight: 'Prawa',
  handednessAmbidextrous: 'Oburęczność',
  raceWhite: 'Biała',
  raceHispanic: 'Hiszpańska',
  raceBlack: 'Czarna',
  raceMena: 'Bliski Wschód / Afryka Północna',
  raceAsian: 'Azjatycka',
  raceNativeAmerican: 'Rdzenni Amerykanie',
  raceNativeHawaiian: 'Rdzenni Hawajczycy',
  thePatient: 'pacjent',
  previousSectionAria: 'Poprzednia sekcja',
  nextSectionAria: 'Następna sekcja',
  listSeparateHint: 'Oddziel pozycje przecinkami',
  medAdd: 'Dodaj',
  medEmpty: 'Brak wpisów.',
  medEntry: 'Wpis {{n}}',
  medRemoveAria: 'Usuń wpis {{label}}',
  medName: 'Nazwa',
  medDosage: 'Dawka',
  medSchedule: 'Schemat',
...
const contactPolish = {
  ...
  placeholderFirstName: 'Opcjonalnie',
  placeholderLastName: 'Opcjonalnie',
