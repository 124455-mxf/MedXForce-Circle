...
const remoteSettingsEnglish = {
  ...
  saving: 'Saving…',
  saved: 'Saved',
  saveFailed: 'Could not save remote settings.',
  ...
  icuEmoji: {
    ...
    desc: 'Choose which emojis appear on the ICU board and drag them into any order. Categories stay in the catalog but do not limit ICU order.',
    hint: 'Default ICU emojis turn on the built-in ICU set.\nHide or display emojis, drag to the desired position',
    defaultHint: 'Default ICU emojis turn on the built-in ICU set.\nHide or display emojis, drag to the desired position',
    globalHint: 'Global emoji layout uses the general patient tablet settings (number of emojis and display order will change).',
    icuOnly: 'These settings only apply while the ICU mode is active!',
    useDefault: 'Default ICU emojis',
    reset: 'Global emoji layout',
    visible: 'Visible',
    hidden: 'Hidden',
    categories: {
      faces: 'Faces & Feelings',
      gestures: 'Gestures',
      people: 'People',
      care: 'Care',
      symbols: 'Symbols',
...
const remoteSettingsGerman = {
  ...
  saving: 'Speichern…',
  saved: 'Gespeichert',
  saveFailed: 'Ferneinstellungen konnten nicht gespeichert werden.',
  ...
  icuOptAlert: 'Alarm',
  icuOptAttention: 'Aufmerksamkeit',
  ...
  icuEmoji: {
    ...
    desc: 'Wählen Sie die Emojis für die ICU-Tafel und ziehen Sie sie in beliebige Reihenfolge. Kategorien bleiben im Katalog, begrenzen die ICU-Reihenfolge aber nicht.',
    hint: 'Standard-ICU-Emojis schalten den eingebauten ICU-Satz ein.\nEmojis ein- oder ausblenden und an die gewünschte Position ziehen',
    defaultHint: 'Standard-ICU-Emojis schalten den eingebauten ICU-Satz ein.\nEmojis ein- oder ausblenden und an die gewünschte Position ziehen',
    globalHint: 'Das globale Emoji-Layout verwendet die allgemeinen Patiententablet-Einstellungen (Anzahl der Emojis und Anzeigereihenfolge ändern sich).',
    icuOnly: 'Diese Einstellungen gelten nur, solange der ICU-Modus aktiv ist!',
    useDefault: 'Standard-ICU-Emojis',
    reset: 'Globales Emoji-Layout',
    visible: 'Sichtbar',
    hidden: 'Ausgeblendet',
    categories: {
      faces: 'Gesichter & Gefühle',
      gestures: 'Gesten',
      people: 'Menschen',
      care: 'Versorgung',
      symbols: 'Symbole',
...
const remoteSettingsSpanish = {
  ...
  saving: 'Guardando…',
  saved: 'Guardado',
  saveFailed: 'No se pudieron guardar los ajustes remotos.',
  ...
  icuEmoji: {
    ...
    desc: 'Elija qué emojis aparecen en el tablero de UCI y arrástrelos en cualquier orden. Las categorías siguen en el catálogo, pero no limitan el orden en UCI.',
    hint: 'Los emojis UCI predeterminados activan el conjunto UCI integrado.\nOculte o muestre emojis y arrástrelos a la posición deseada',
    defaultHint: 'Los emojis UCI predeterminados activan el conjunto UCI integrado.\nOculte o muestre emojis y arrástrelos a la posición deseada',
    globalHint: 'El diseño global de emojis usa la configuración general de la tableta del paciente (cambiarán el número de emojis y el orden de visualización).',
    icuOnly: '¡Estos ajustes solo aplican mientras el modo UCI está activo!',
    useDefault: 'Emojis UCI predeterminados',
    reset: 'Diseño global de emojis',
    visible: 'Visible',
    hidden: 'Oculto',
    categories: {
      faces: 'Caras y sentimientos',
      gestures: 'Gestos',
      people: 'Personas',
      care: 'Cuidados',
      symbols: 'Símbolos',
...
const remoteSettingsPolish = {
  ...
  saving: 'Zapisywanie…',
  saved: 'Zapisano',
  saveFailed: 'Nie udało się zapisać ustawień zdalnych.',
  ...
  icuEmoji: {
    ...
    desc: 'Wybierz emoji na tablicy OIOM i ustaw dowolną kolejność. Kategorie zostają w katalogu, ale nie ograniczają układu w OIOM.',
    hint: 'Domyślne emoji OIOM włączają wbudowany zestaw OIOM.\nUkrywaj lub pokazuj emoji i przeciągaj je na wybraną pozycję',
    defaultHint: 'Domyślne emoji OIOM włączają wbudowany zestaw OIOM.\nUkrywaj lub pokazuj emoji i przeciągaj je na wybraną pozycję',
    globalHint: 'Globalny układ emoji korzysta z ogólnych ustawień tabletu pacjenta (zmieni się liczba emoji i kolejność wyświetlania).',
    icuOnly: 'Te ustawienia działają tylko wtedy, gdy tryb OIOM jest aktywny!',
    useDefault: 'Domyślne emoji OIOM',
    reset: 'Globalny układ emoji',
    visible: 'Widoczne',
    hidden: 'Ukryte',
    categories: {
      faces: 'Twarze i uczucia',
      gestures: 'Gesty',
      people: 'Ludzie',
      care: 'Opieka',
      symbols: 'Symbole',
