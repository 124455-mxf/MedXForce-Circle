...
const remoteSettingsEnglish = {
  ...
  icuEmoji: {
    ...
    hint: 'Default ICU emojis turns on the built-in set. Global layout follows the tablet catalog under Communication → Content Management. These settings only apply while ICU mode is active.',
...
const remoteSettingsGerman = {
  ...
  icuEmoji: {
    ...
    hint: 'Standard-ICU-Emojis schaltet den eingebauten Satz ein. Das globale Layout folgt dem Tablet-Katalog unter Kommunikation → Inhaltsverwaltung. Diese Auswahl gilt nur im ICU-Modus.',
...
const remoteSettingsSpanish = {
  ...
  icuEmoji: {
    ...
    hint: 'Los emojis UCI predeterminados activan el conjunto integrado. El diseño global sigue el catálogo de la tableta en Comunicación → Gestión de contenido. Estos ajustes solo aplican en modo UCI.',
...
const remoteSettingsPolish = {
  ...
  icuEmoji: {
    ...
    hint: 'Domyślne emoji OIOM włączają wbudowany zestaw. Globalny układ korzysta z katalogu tabletu w Komunikacja → Zarządzanie treścią. Te ustawienia działają tylko w trybie OIOM.',
