...
const remoteSettingsEnglish = {
  ...
  icuOptBoardLanguage: 'Sentences & words (with AI suggestions)',
...
const remoteSettingsGerman = {
  ...
  icuOptBoardLanguage: 'Sätze & Wörter (mit KI-Vorschlägen)',
...
const remoteSettingsSpanish = {
  ...
  icuOptBoardLanguage: 'Frases y palabras (con sugerencias de IA)',
...
const remoteSettingsPolish = {
  ...
  icuOptBoardLanguage: 'Zdania i słowa (z sugestiami AI)',
