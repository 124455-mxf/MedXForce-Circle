...
const remoteSettingsEnglish = {
  ...
  icuEmoji: {
    ...
    hint: 'The master catalog stays on the patient tablet under Communication → Content Management. These settings only apply while ICU mode is active.',
    reset: 'Use global emoji layout',
    visible: 'Visible',
    hidden: 'Hidden',
    categories: {
...
const remoteSettingsGerman = {
  ...
  icuEmoji: {
    ...
    hint: 'Der Emoji-Katalog bleibt auf dem Patiententablet unter Kommunikation → Inhaltsverwaltung. Diese Auswahl gilt nur im ICU-Modus.',
    reset: 'Globales Emoji-Layout verwenden',
    visible: 'Sichtbar',
    hidden: 'Ausgeblendet',
    categories: {
...
const remoteSettingsSpanish = {
  ...
  icuEmoji: {
    ...
    hint: 'El catálogo maestro permanece en la tableta del paciente en Comunicación → Gestión de contenido. Estos ajustes solo aplican en modo UCI.',
    reset: 'Usar diseño global de emojis',
    visible: 'Visible',
    hidden: 'Oculto',
    categories: {
...
const remoteSettingsPolish = {
  ...
  icuEmoji: {
    ...
    hint: 'Główny katalog pozostaje na tablecie pacjenta w Komunikacja → Zarządzanie treścią. Te ustawienia działają tylko w trybie OIOM.',
    reset: 'Użyj globalnego układu emoji',
    visible: 'Widoczne',
    hidden: 'Ukryte',
    categories: {
